...
import { History, X, FlaskConical, Brain, Trophy, Calendar, AlertTriangle } from 'lucide-react';
                ...
                {puntuacionRRHH && (
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {fechaEntrevistaRRHH && (
                        <span className="text-xs text-gray-400">({formatFechaDia(fechaEntrevistaRRHH)})</span>
                      )}
                    </div>
                  </div>
                )}
                  ...
                  <div className="flex items-center justify-between flex-wrap gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {fechaEntrevistaAreaTecnica && (
                        <span className="text-xs text-gray-400">({formatFechaDia(fechaEntrevistaAreaTecnica)})</span>
                      )}
                    </div>
                  </div>
                )}
                ...
                {examenFisico && (
                  <div className="border-b border-teal-100 pb-2 last:border-0">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-xs text-gray-400">{formatFechaDia(examenFisico.fecha)}</span>
                    </div>
                ...
                {examenPsicotecnico && (
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-xs text-gray-400">{formatFechaDia(examenPsicotecnico.fecha)}</span>
                    </div>
                        ...
                        {item.motivo && (
                          <div className="mb-3 p-2 bg-red-100 rounded-lg border border-red-200">
                            <div className="flex items-start gap-2">
                              ...
                              <div>
                                <span className="text-xs font-medium text-red-700">Motivo:</span>
                                <p className="text-sm text-red-800">{item.motivo}</p>
                              </div>
                            </div>
                          </div>
                        )}
