...
import { 
  ...
  GraduationCap, MapPin, Search, ChevronRight, Eye, Shield 
} from 'lucide-react';
...
export const CVUploadForm: React.FC<CVUploadFormProps> = ({ onSuccess }) => {
  ...
  const [selectedPuestoInfo, setSelectedPuestoInfo] = useState<BusquedaActiva | null>(null);
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <button
                            ...
                            title="Acerca del puesto"
                          >
                            <Eye className="w-4 h-4"/>
                          </button>
                        </div>
                        <p className="text-xs text-gray-500 mt-0.5">{b.area} · {b.puesto} · {b.lugarResidencia}</p>
                      </div>
                    </label>
                  );
                })}
