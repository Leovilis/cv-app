...
export interface HistorialInstancia {
  ...
  puntuacion?: number;  // 1-10, solo para entrevistas
  motivo?: string;      // motivo de descarte o de salida
  notas?: string;       // observaciones adicionales
  realizadoPor: string; // email del admin que realizó la acción
}

export interface CVConTrazabilidad extends CV {
  ...
  motivoQuitadoProceso?: string;  // si fue quitado del proceso
  fechaQuitadoProceso?: string;
}

// Actualizar ESTADOS_SELECCION si es necesario
// export const ESTADOS_SELECCION = [
//   'En Curso',
//   'Entrevista RRHH',
//   'Entrevista Área Técnica',  // cambio de nombre
//   'Terna Preseleccionados',
//   'Seleccionado',
//   'Descartado',
//   'Aprobado',
//   'Rechazado',
//   'Contratado',
//   'Quitado del Proceso'  // nuevo estado
// ];
...
// lib/types.ts
// ============================================
// TIPOS EXISTENTES (mantener lo que ya tenías)
// ============================================
...
// Tipos para el ranking y trazabilidad
...
// ============================================
// CONSTANTES EXISTENTES (si ya las tenías)
// ============================================
