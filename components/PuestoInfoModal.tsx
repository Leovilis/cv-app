// components/PuestoInfoModal.tsx - Para mostrar al postulante
...
export const PuestoInfoModal: React.FC<PuestoInfoModalProps> = ({
  busqueda,
  onClose,
}) => {
  return (
          ...
          <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
            <div className="flex items-center gap-2 text-gray-600">
              ...
              <span className="text-sm">
                Ubicación: <strong>{busqueda.lugarResidencia}</strong>
              </span>
            </div>
          </div>
            ...
            !busqueda.beneficios && (
              <div className="text-center py-8 text-gray-500">
                ...
                <p className="text-sm mt-1">
                  Pronto estará disponible más información.
                </p>
              </div>
            )}
        </div>
